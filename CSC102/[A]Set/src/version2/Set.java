...
// --------------------- CAUTION --------------------- 
// ========================================================
// - ArrayList, and every helper methods in Arrays Class are forbidden. // Pure Framework
// ========================================================
// ========================================================
public class Set {
    ...
    private void removeDuplicate() {
        java.util.Set<Double> result = new HashSet<Double>();
        for (double i : number) {
            result.add(i);
        }
    ...
    public boolean equals(Set set) {
        java.util.Set<Double> result = new LinkedHashSet<Double>(); // Arrays.asList() inside parenthess
        java.util.Set<Double> result2 = new LinkedHashSet<Double>();
    ...
    public String getStringValue() {
        java.util.Set<Double> result = new LinkedHashSet<Double>();
        for (double i : number) {
            result.add(i);
        }
